...
public class GalleryDelegate {
    ...
    private GallerySnapHelper.SnapListener listener;
    ...
    public GalleryDelegate(int gravity, boolean enableSnapLast,
                           @Nullable GallerySnapHelper.SnapListener listener) {
