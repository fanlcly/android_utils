...
public abstract class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider.getLeftSideLine().isHave()) {
                int lineWidthPx = DensityUtils.dp2px(context, divider.getLeftSideLine().getWidthDp());
                int startPaddingPx = DensityUtils.dp2px(context, divider.getLeftSideLine().getStartPaddingDp());
                int endPaddingPx = DensityUtils.dp2px(context, divider.getLeftSideLine().getEndPaddingDp());
            ...
            if (divider.getTopSideLine().isHave()) {
                int lineWidthPx = DensityUtils.dp2px(context, divider.getTopSideLine().getWidthDp());
                int startPaddingPx = DensityUtils.dp2px(context, divider.getTopSideLine().getStartPaddingDp());
                int endPaddingPx = DensityUtils.dp2px(context, divider.getTopSideLine().getEndPaddingDp());
            ...
            if (divider.getRightSideLine().isHave()) {
                int lineWidthPx = DensityUtils.dp2px(context, divider.getRightSideLine().getWidthDp());
                int startPaddingPx = DensityUtils.dp2px(context, divider.getRightSideLine().getStartPaddingDp());
                int endPaddingPx = DensityUtils.dp2px(context, divider.getRightSideLine().getEndPaddingDp());
            ...
            if (divider.getBottomSideLine().isHave()) {
                int lineWidthPx = DensityUtils.dp2px(context, divider.getBottomSideLine().getWidthDp());
                int startPaddingPx = DensityUtils.dp2px(context, divider.getBottomSideLine().getStartPaddingDp());
                int endPaddingPx = DensityUtils.dp2px(context, divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int left = divider.getLeftSideLine().isHave() ? DensityUtils.dp2px(context, divider.getLeftSideLine().getWidthDp()) : 0;
        int top = divider.getTopSideLine().isHave() ? DensityUtils.dp2px(context, divider.getTopSideLine().getWidthDp()) : 0;
        int right = divider.getRightSideLine().isHave() ? DensityUtils.dp2px(context, divider.getRightSideLine().getWidthDp()) : 0;
        int bottom = divider.getBottomSideLine().isHave() ? DensityUtils.dp2px(context, divider.getBottomSideLine().getWidthDp()) : 0;
